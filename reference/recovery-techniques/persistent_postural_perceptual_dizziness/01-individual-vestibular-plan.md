...
1. **Name one ordinary goal.** Perhaps you want to turn towards someone at the table, reach the bathroom safely or use a screen for a short message.
2. **Describe the difficulty.** Is it rocking, spinning, faintness, blurred vision or loss of balance? Say when it happens and how long its effects last.
3. **Ask for a demonstration and an accessible copy.** The plan should specify the task, position, equipment, amount, stopping point and who to contact.
4. **Agree how to judge the response.** Consider the activity itself, falls or near-falls, symptoms later that day and the effect on other necessary tasks. Progression is a shared decision.

These planning examples are educational adaptations, not a trial protocol. A short supported activity can count as useful participation even when dizziness remains. (*citations* [2](#citation-2), [4](#citation-4))
...
| <a id="citation-3"></a>3 | [FND-CIT-0040](../../../research/citation-index.md#fnd-cit-0040) — Webster KE, Kamo T, Smith L, et al. Non-pharmacological interventions for persistent postural-perceptual dizziness (PPPD). *Cochrane Database of Systematic Reviews*. 2023;3:CD015333. [DOI](https://doi.org/10.1002/14651858.CD015333.pub2). | Strict comparator and follow-up criteria left very limited evidence; not proof that rehabilitation cannot help. | — |
| <a id="citation-4"></a>4 | [FND-CIT-0196](../../../research/citation-index.md#fnd-cit-0196) — Neurosymptoms.org. *Functional Dizziness (PPPD)*. [Specialist patient information](https://neurosymptoms.org/en/symptoms/fnd-symptoms/functional-dizziness-pppd/). Accessed September 22, 2026. | Specialist explanation and treatment context; not a controlled treatment trial. | — |
