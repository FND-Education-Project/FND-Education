...
[Home](../../../README.md) › [Recovery Techniques](../README.md) › [Cough collection](README.md)

> **Working draft:** Automatically generated educational material; clinical, lived-experience and accessibility review pending. [Contributors and reviewers welcome](https://fnd-education-project.github.io/FND-Education/).

**Original entry 10: Treat coexisting conditions.** This page expands the original list rather than adding a new intervention. **[Professional consensus; individual assessment required]**
...
- **[FND-CIT-0025](../../../research/citation-index.md#fnd-cit-0025):** Baker J, Barnett C, Cavalli L, et al. Management of functional communication, swallowing, cough and related disorders: consensus recommendations for speech and language therapy. *JNNP*. 2021;92(10):1112–1125. [DOI](https://doi.org/10.1136/jnnp-2021-326767). FND-related speech and language therapy consensus; component-specific evidence is limited.

- **[FND-CIT-0129](../../../research/citation-index.md#fnd-cit-0129):** Vertigan AE, Murad MH, Pringsheim T, et al. Somatic Cough Syndrome (Previously Referred to as Psychogenic Cough) and Tic Cough (Previously Referred to as Habit Cough) in Adults and Children: CHEST Guideline and Expert Panel Report. *Chest*. 2015;148(1):24–31. [DOI](https://doi.org/10.1378/chest.15-0423). Diagnostic terminology and boundaries; not a trial of this technique.

- **[FND-CIT-0147](../../../research/citation-index.md#fnd-cit-0147):** Haines J, Esposito K, Slinger C, et al. UK consensus statement on the diagnosis of inducible laryngeal obstruction in light of the COVID-19 pandemic. *Clinical & Experimental Allergy*. 2020;50(12):1287–1293. [DOI](https://doi.org/10.1111/cea.13745). Supports specialist diagnostic assessment; pandemic access arrangements are historical, not a general reason to omit laryngoscopy.

*Source review: September 20, 2026 · Human review pending*

**Continue:** [Next page](../12-functional-cognitive-disorder.md) · [Previous page](09-attention-and-arousal-support.md) · [Symptom overview](../11-functional-cough-and-upper-airway-symptoms.md) · [Site map](../../../SITEMAP.md)
