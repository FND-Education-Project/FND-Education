...
[Home](../../../README.md) › [Reference Library](../../README.md) › [Recovery Techniques](../README.md) › [Functional Speech and Voice Symptoms](../09-functional-speech-and-voice-symptoms.md) › **Psychologically Informed Support for Communication**
<!-- NAV-BREADCRUMB:END -->
...
1. Ask whether the person wants help with the emotional or social burden of communication.
2. Agree one specific difficulty and distinguish practical barriers from predictions or coping patterns.
3. Explain the proposed approach, its limits and alternatives.
4. Plan a manageable activity or coping response with consent and backup communication.
5. Review participation, distress and costs without equating symptom persistence with failed engagement.
6. Refer or collaborate for mental-health needs beyond the speech-language clinician’s scope.
...
<!-- NAV-CONTEXT:START -->
**Continue:** [Previous page](09-communication-support-and-aac.md) · [Next page](11-coexisting-conditions-and-reassessment.md)
