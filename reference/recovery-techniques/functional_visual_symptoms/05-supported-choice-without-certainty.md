...
[Home](../../../README.md) › [Reference Library](../../README.md) › [Recovery Techniques](../README.md) › [Functional Visual Symptoms](../08-functional-visual-symptoms.md) › **Supported Visual Choice Without Waiting for Certainty**
<!-- NAV-BREADCRUMB:END -->
...
1. Identify why a low-certainty choice could help this person’s agreed rehabilitation goal.
2. Explain the task and the right to pass or stop.
3. Use a small number of simple, safe choices in a stable seated setting.
4. Record the response without equating accuracy with conscious visual experience or normal vision.
5. Offer transparent feedback and ask whether the task was useful or uncomfortable.
6. Continue only if it supports a meaningful activity; do not assign repeated home testing to supporters.
...
<!-- NAV-CONTEXT:START -->
**Continue:** [Previous page](04-graded-visual-task-practice.md) · [Next page](06-photophobia-light-and-protection-plan.md)
