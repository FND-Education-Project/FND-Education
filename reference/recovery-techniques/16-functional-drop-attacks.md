...
[Home](../../README.md) › [Reference Library](../README.md) › [Recovery Techniques](README.md) › **Recovery and Safety Techniques for Functional Drop Attacks**
<!-- NAV-BREADCRUMB:END -->
...
1. **Agree on an injury-response plan — C.** Decide when to stay still, check for injury, use first aid, seek urgent help and resume activity. Include head injury, bleeding, severe pain and inability to bear weight.
2. **Reduce avoidable fall hazards — C.** Review footwear, stairs, bathroom safety, sharp edges, carrying hot items, driving, heights and lone activities. Make changes proportionate so safety planning does not become total withdrawal from life.
3. **Use the prescribed mobility strategy — C.** An appropriate aid, seat access, companion or route change may support participation. Equipment should be individually assessed and reviewed; it is neither automatically a cure nor a failure.
4. **Look for a warning without inventing one — E.** Some people identify a very brief sensation, disconnection or change in movement; many report none. If a reliable warning exists, practise one action such as sitting, reaching stable support or stopping the task. If there is no warning, focus on environment and injury response.
5. **Recover without turning the floor into a test — C.** After a familiar uninjured event, pause, orient, check the body and use the agreed method to rise. Do not repeatedly stand to prove that another attack will not happen.
6. **Rebuild avoided activity gradually — E/C.** With clinical guidance, choose a meaningful setting, adequate support and a manageable duration. Increase only when safety and recovery are acceptable. Treatment of fear or avoidance may help some people, but it is not evidence that fear caused every fall.
7. **Treat overlapping conditions separately — C.** Functional gait or weakness, functional seizures, pain, dizziness, syncope, sleep disorders and other conditions may coexist. Improvement in one does not prove the cause of every attack.
...
- Seek urgent help for serious injury, definite loss of consciousness, chest pain, breathing difficulty, sustained palpitations, new neurological symptoms, prolonged confusion or delayed recovery.
