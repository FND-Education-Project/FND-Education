...
[Home](../../../README.md) › [Reference Library](../../README.md) › [Recovery Techniques](../README.md) › [Functional Dystonia or Fixed Posturing](../04-functional-dystonia.md) › **Position and Gravity Change**
<!-- NAV-BREADCRUMB:END -->
...
Consensus and functional-dystonia reviews describe changing posture relative to gravity, avoiding prolonged end range, and building movement from positions where it is available. The technique has not been isolated in a controlled functional-dystonia trial. (*citations* [1](#citation-1), [2](#citation-2), [3](#citation-3))
