...
[Home](../../../README.md) › [Reference Library](../../README.md) › [Recovery Techniques](../README.md) › [Functional Dystonia or Fixed Posturing](../04-functional-dystonia.md) › **Pain, Skin, Joint-Range and Contracture Management**
<!-- NAV-BREADCRUMB:END -->
...
1. Identify the immediate tissue, joint or pain risk and define the purpose of intervention.
2. Establish baseline skin, neurovascular status, active/passive range, pain, hygiene access, sleep and participation.
3. Remove avoidable pressure, shear, moisture or unsafe handling.
4. Select comfortable active movement and positioning within tissue tolerance. Use passive movement only when indicated, consented and non-forceful.
5. Treat a confirmed pain, skin, inflammatory, musculoskeletal or neuropathic condition according to its own standards of care.
6. Coordinate equipment only when it advances the defined protection or function goal.
7. Reassess range, skin and pain at a frequency matched to risk.
8. Return to active functional retraining when safe; do not wait for complete symptom resolution if meaningful participation can be supported.
...
Functional-dystonia reviews recognize pain, complex regional pain syndrome and secondary contracture, while consensus cautions against forceful passive correction. Evidence does not supply one complication protocol for every phenotype. (*citations* [1](#citation-1), [2](#citation-2), [3](#citation-3), [4](#citation-4))
