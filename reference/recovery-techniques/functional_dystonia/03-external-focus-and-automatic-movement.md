...
[Home](../../../README.md) › [Reference Library](../../README.md) › [Recovery Techniques](../README.md) › [Functional Dystonia or Fixed Posturing](../04-functional-dystonia.md) › **External Focus and Automatic Movement**
<!-- NAV-BREADCRUMB:END -->
...
1. Agree on one functional goal and explain why task focus may reduce excessive conscious control.
2. Establish a safe starting position and an easy version of the task.
3. Record the direct-command baseline only if necessary; do not repeatedly provoke failure.
4. Select one external target: object, destination, line, rhythm, sound or environmental effect.
5. Cue the task outcome with few words. Avoid simultaneous instructions to relax, correct alignment and monitor pain unless safety requires them.
6. Reinforce useful movement and task completion. Do not announce every fluctuation in posture.
7. Repeat briefly, then vary the object or setting so learning is not tied to one clinic prop.
8. Progress toward the person’s actual activity and provide one regression option.
