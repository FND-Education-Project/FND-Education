...
[Home](../../../README.md) › [Reference Library](../../README.md) › [Recovery Techniques](../README.md) › [Functional Dystonia or Fixed Posturing](../04-functional-dystonia.md) › **Specialist Botulinum-Toxin Review**
<!-- NAV-BREADCRUMB:END -->
...
1. Confirm the diagnostic formulation and document uncertainty or comorbidity.
2. Define one measurable goal and why focal chemodenervation is expected to help it.
3. Record baseline posture, pain, passive/active range, strength, swallowing or gait as relevant, task function and assistance.
4. Discuss the pilot-trial result, uncertainty, time course, temporary nature and target-specific risks through shared decision-making.
5. Select muscle and dose using specialist standards; avoid injecting diffuse “tightness” without a target hypothesis.
6. Coordinate a time-limited rehabilitation plan that uses any reduced overactivity without forcing range.
7. Review at an appropriate interval using the predefined functional goal and adverse effects.
8. Do not repeat automatically. Continue, modify or stop according to net benefit and diagnostic formulation.
...
Focused review discusses occasional targeted use, particularly with objective painful spasm, while also noting immediate responses inconsistent with the drug’s delayed mechanism. Present both the uncertainty and procedure-related risks. Community reports of temporary benefit, no benefit or worsening are individual experiences, not effectiveness estimates. (*citations* [1](#citation-1), [2](#citation-2), [3](#citation-3))
...
|---|---|
| <a id="citation-1"></a>**[1]** | Vizcarra JA, Lopez-Castellanos JR, Dwivedi AK, Schmerler DA, Ries S, Espay AJ. OnabotulinumtoxinA and cognitive behavioral therapy in functional dystonia: a pilot randomized clinical trial. *Parkinsonism & Related Disorders*. 2019;63:174–178. [FND-CIT-0093](../../../research/citation-index.md#fnd-cit-0093). [https://doi.org/10.1016/j.parkreldis.2019.02.009](https://doi.org/10.1016/j.parkreldis.2019.02.009) |
