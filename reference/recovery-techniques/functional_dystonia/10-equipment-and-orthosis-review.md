...
[Home](../../../README.md) › [Reference Library](../../README.md) › [Recovery Techniques](../README.md) › [Functional Dystonia or Fixed Posturing](../04-functional-dystonia.md) › **Equipment and Orthosis Review**
<!-- NAV-BREADCRUMB:END -->
...
Consensus and focused review provide cautionary principles, not a trial-derived rule that equipment must always be avoided or rapidly removed. The correct balance between movement retraining, safety and access requires shared review. (*citations* [1](#citation-1), [2](#citation-2), [3](#citation-3))
