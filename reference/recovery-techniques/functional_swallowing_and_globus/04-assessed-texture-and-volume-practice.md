...
[Home](../../../README.md) › [Reference Library](../../README.md) › [Recovery Techniques](../README.md) › [Swallowing and Globus](README.md) › **Practising With Assessed Food Textures and Amounts**
<!-- NAV-BREADCRUMB:END -->

> **Automatically generated working draft:** This page is [looking for contributors and reviewers](https://fnd-education-project.github.io/FND-Education/). Swallowing-specialist, relevant medical, dietetic, lived-experience and accessibility review pending.
...
1. Ask for the starting food or drink, amount, assistance and stopping rule in writing.
2. Practise only the specific trial approved for you, without adding a second challenge.
3. Keep the agreed nutrition and hydration backup while the plan is reviewed.

These are discussion points for an individualized plan, not instructions to test swallowing at home. (*citations* [1](#citation-1), [2](#citation-2))
...
1. Confirm the baseline and reason for changing a single parameter.
2. Observe the selected trial and relevant airway/efficiency indicators, using instrumental information when required.
3. Review nutritional adequacy, hydration, acceptance and sustainable implementation before progression.
...
<!-- NAV-CONTEXT:START -->
**Continue:** [Next page: Making Meals More Manageable in Different Settings](05-meal-setting-and-participation.md)

**Related:** [Previous](03-jaw-neck-and-laryngeal-release.md) · [Eleven-entry collection](README.md) · [Swallowing overview and flare plan](../10-functional-swallowing-and-globus.md) · [Diagnostic assessment](../../diagnostic-signs/10-functional-swallowing-and-globus.md)
