...
[Home](../../../README.md) › [Reference Library](../../README.md) › [Recovery Techniques](../README.md) › [Swallowing and Globus](README.md) › **Stepping Back From Repeated Throat Checking**
<!-- NAV-BREADCRUMB:END -->
...
1. Describe the checking pattern once, without deliberately recreating it.
2. Agree a simple alternative and a separate rule for new or worsening symptoms.
3. Notice whether the day becomes less dominated by checking, rather than counting every swallow.
...
1. Identify the precise checking behavior and establish its clinical context.
2. Agree a tolerable alternative that does not require unassessed oral intake.
3. Monitor functional impact and stop if the plan interferes with swallowing safety or help-seeking.
...
<!-- NAV-CONTEXT:START -->
**Continue:** [Next page: Using a Gentle External Focus During Assessed Practice](07-safe-external-focus.md)

**Related:** [Previous](05-meal-setting-and-participation.md) · [Eleven-entry collection](README.md) · [Swallowing overview and flare plan](../10-functional-swallowing-and-globus.md) · [Diagnostic assessment](../../diagnostic-signs/10-functional-swallowing-and-globus.md)
