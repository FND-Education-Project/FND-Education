...
[Home](../../../README.md) › [Reference Library](../../README.md) › [Recovery Techniques](../README.md) › [Swallowing and Globus](README.md) › **A Prescriber-Led Medication Discussion for Assessed Globus**
<!-- NAV-BREADCRUMB:END -->
...
1. Bring a current medicine list and tell the prescriber about relevant conditions and previous reactions.
2. Agree how benefit and adverse effects will be assessed and when to contact the prescriber.
3. Ask about swallowing the preparation safely; do not start, increase, stop or crush a medicine based on this page.

These are discussion points for an individualized plan, not instructions to test swallowing at home. (*citations* [1](#citation-1), [2](#citation-2), [3](#citation-3))
...
1. Document the indication and uncertainty in a shared decision.
2. Review risks, interactions, oral formulation and monitoring with pharmacy where indicated.
3. Set a review or stopping strategy and continuing care if medication is ineffective or declined.
