...
[Home](../../../README.md) › [Reference Library](../../README.md) › [Recovery Techniques](../README.md) › [Functional Jerks or Myoclonus](../03-functional-jerks-and-myoclonus.md) › **Pattern and Warning Mapping**
<!-- NAV-BREADCRUMB:END -->
...
Look for a small number of repeatable decisions. A warning that gives several seconds may support an [early attention-redirection strategy](02-early-attention-redirection.md). A consistent pre-jerk posture may lead to [competing or continuous movement](03-competing-and-continuous-movement.md). Pain or marked bracing may need its own assessment. No warning is also a useful finding: the immediate plan should then emphasize safety rather than demanding control that is not available.
...
The functional-motor physiotherapy consensus specifically notes that conventional movement retraining may be difficult for intermittent, sudden jerks and recommends looking for self-focused attention or premonitory symptoms that can be addressed through redirected attention. This is consensus guidance, not proof that warning mapping or redirection works for every person. (*citations* [1](#citation-1), [2](#citation-2), [3](#citation-3))
