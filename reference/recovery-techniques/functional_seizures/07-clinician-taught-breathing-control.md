...
[Home](../../../README.md) › [Reference Library](../../README.md) › [Recovery Techniques](../README.md) › [Functional Seizures](../06-functional-seizures.md) › **Clinician-Taught Breathing Control**
<!-- NAV-BREADCRUMB:END -->
...
Breathing control is a taught skill, not advice to take repeated huge breaths. The **diaphragm** is the broad breathing muscle beneath the lungs; the ribs and other breathing muscles also contribute. **Hyperventilation** means breathing more than the body needs, which can lower carbon dioxide. It is not the same as every episode of breathlessness and cannot be diagnosed from a feeling alone. (*citations* [1](#citation-1), [2](#citation-2), [3](#citation-3))
...
1. Review cardiopulmonary history, medication, event pattern and reasons for dyspnoea (breathlessness); investigate red flags first.
2. Assess respiratory rate, depth, thoracoabdominal coordination (how the rib cage and abdomen move together), accessory-muscle use and symptom response in a comfortable position.
3. Explain the chosen approach without presenting hypocapnia (low carbon dioxide) as a demonstrated mechanism in every patient.
4. Teach a comfortable pattern using individualized feedback within professional competence. Symptom questionnaires alone do not establish hyperventilation or rule out disease.
5. Specify practice context, duration and stop criteria based on assessment rather than copying a generic ratio.
6. Review dizziness, air hunger, dissociation, fatigue and delayed worsening; shorten, modify or stop as indicated.
7. Integrate only a tolerable rehearsed cue into the warning plan, with an explicit no-warning and impaired-awareness fallback.
...
Breathing remains an emerging option. The scoping review and protocol qualify the pilot rather than converting it into established treatment evidence. (*citations* [1](#citation-1), [2](#citation-2), [3](#citation-3))
...
<!-- NAV-CONTEXT:START -->
**Continue:** [Previous technique](06-react-for-children-and-adolescents.md) · [Next technique](08-coexisting-condition-and-load-review.md)
...
|---|---|
| <a id="citation-1"></a>**[1]** | Duncan R, Berlowitz DJ, Mullen S, et al. Breathing control training for functional seizures: a multi-site, open-label pilot study. *Epilepsy & Behavior*. 2024;154:109745. [https://doi.org/10.1016/j.yebeh.2024.109745](https://doi.org/10.1016/j.yebeh.2024.109745) [FND-CIT-0034](../../../research/citation-index.md#fnd-cit-0034). |
| <a id="citation-2"></a>**[2]** | Kanaan R, Duncan R, Mihalopoulos C, et al. Breathing control training as a treatment for functional seizures (BREATHS trial): a multicentre, assessor-blinded, randomised controlled efficacy and acceptability trial study protocol. *BMJ Open*. 2026;16(1):e107687. [doi:10.1136/bmjopen-2025-107687](https://doi.org/10.1136/bmjopen-2025-107687) [FND-CIT-0095](../../../research/citation-index.md#fnd-cit-0095). |
| <a id="citation-3"></a>**[3]** | Zouki JJ, Ye H, Lo APK, et al. The therapeutic effect of breathing interventions for functional seizures: A scoping review. *Epilepsy & Behavior*. 2026;178:110919. [doi:10.1016/j.yebeh.2026.110919](https://doi.org/10.1016/j.yebeh.2026.110919) [FND-CIT-0096](../../../research/citation-index.md#fnd-cit-0096). |
