...
[Home](../../../README.md) › [Reference Library](../../README.md) › [Recovery Techniques](../README.md) › [Functional Seizures](../06-functional-seizures.md) › **Supporter Response Rehearsal**
<!-- NAV-BREADCRUMB:END -->
...
Agree who should stay nearby, what they should say and which kinds of touch or sensory input are unwelcome. A simple plan can reduce the number of decisions needed during an episode. It should respect your preferences without asking a supporter to ignore a medical emergency. (*citations* [1](#citation-1), [2](#citation-2))
...
1. Obtain consent for which supporters receive information; consider the young person’s involvement and safeguarding where relevant.
2. Check the event and emergency plan before rehearsing its implementation.
3. Assign realistic roles: environmental safety, timing, communication, medical escalation and recovery assistance.
4. Use a verbal tabletop scenario. Do not deliberately trigger symptoms or simulate hazardous movements.
5. Ask supporters to describe their response to a typical event and to one clear exception, such as abnormal breathing.
6. Clarify any conflict between quiet reassurance and necessary escalation.
7. Check physical handling limits, sensory accommodations, language, literacy and caregiver capacity.
8. Review the plan after an event without blame and update all authorized copies.
...
Guidance supports involving chosen supporters and consistent care. The verbal rehearsal is an original implementation example; no separate trial establishes its seizure-reduction effect. (*citations* [1](#citation-1), [2](#citation-2))
