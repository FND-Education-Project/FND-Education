...
[Home](../../../README.md) › [Reference Library](../../README.md) › [Recovery Techniques](../README.md) › [Functional Seizures](../06-functional-seizures.md) › **Prescriber-Led Medication Review**
<!-- NAV-BREADCRUMB:END -->
...
A medicine called an antiseizure medicine may be prescribed for epilepsy or for another reason, such as a pain or mood condition. Ask the prescriber to explain its purpose before making a change. A diagnosis of functional seizures does not automatically mean every medicine should stop. (*citations* [1](#citation-1))
...
1. Reconcile prescribed, over-the-counter and as-needed medicines, actual use and prescribers.
2. Map every medication to a current indication and every rescue instruction to an event type.
3. Revisit diagnostic uncertainty, including coexisting epilepsy, before withdrawing treatment.
4. Explain expected benefits, adverse effects, interactions and the risks of abrupt change in accessible terms.
5. When withdrawal is indicated, provide a drug-specific, individualized taper and monitoring plan; this reference supplies no dosing schedule.
6. Coordinate with the other prescribers and document what to do during uncertainty or deterioration.
7. Review tolerability and the original indication after the change, not only functional-seizure counts.
...
The AAN medication recommendations address functional seizures without epilepsy or another indication. The reconciliation steps are a practical clinical workflow, not a drug-specific prescribing protocol. (*citations* [1](#citation-1))
...
<!-- NAV-CONTEXT:START -->
**Continue:** [Next page: Supported Return to Activities for Functional Seizures](10-supported-return-to-activities.md)

**Related:** [Previous technique](08-coexisting-condition-and-load-review.md) · [Technique collection and CBT resources](README.md) · [Seizure recovery overview](../06-functional-seizures.md) · [Episode safety plan](02-individualized-episode-safety-plan.md) · [Diagnostic reference](../../diagnostic-signs/06-functional-seizures.md)
