...
[Home](../../../README.md) › [Reference Library](../../README.md) › [Recovery Techniques](../README.md) › [Functional Seizures](../06-functional-seizures.md) › **Seizure-Focused Psychological Treatment**
<!-- NAV-BREADCRUMB:END -->
...
The [existing resource map and booklet plans](README.md) explain learning materials. The planned booklets are not a finished treatment manual.
...
1. Confirm diagnostic communication, medical follow-up and an event safety plan.
2. Ask about the person’s goals, prior treatment experiences and access needs; offer an informed choice of available approaches.
3. Build a collaborative formulation, distinguishing hypothesis from fact and including physical and social circumstances.
4. Choose one target and explain the proposed skill and its limits before rehearsal.
5. Agree a feasible between-session task, with a less demanding version and a stopping rule.
6. Review benefit, burden and adverse effects; adapt rather than interpret difficulty as resistance.
7. Coordinate any treatment for PTSD, depression, pain or sleep with the appropriate clinician.
8. Plan continuing support and relapse review whether or not seizure frequency changes.

### Evidence, outcomes and progression

The CODES adult trial randomized 368 people. Its primary monthly seizure-frequency outcome at 12 months did not differ significantly; several secondary outcomes favoured CBT, including aspects of functioning and quality of life. Secondary comparisons were not adjusted for multiplicity. This supports a balanced discussion, not a claim that CBT reliably stops seizures. The smaller earlier trial provides pilot evidence. (*citations* [2](#citation-2), [3](#citation-3))
...
AAN describes psychological interventions as possibly effective. CODES and the pilot evaluate treatment packages, not proof of each worksheet, thought exercise or grounding component. (*citations* [1](#citation-1), [2](#citation-2), [3](#citation-3))
...
| <a id="citation-3"></a>**[3]** | LaFrance WC Jr, Baird GL, Barry JJ, et al. Multicenter pilot treatment trial for psychogenic nonepileptic seizures: a randomized clinical trial. *JAMA Psychiatry*. 2014;71(9):997–1005. [https://doi.org/10.1001/jamapsychiatry.2014.817](https://doi.org/10.1001/jamapsychiatry.2014.817) [FND-CIT-0032](../../../research/citation-index.md#fnd-cit-0032). |
...
<!-- NAV-CONTEXT:START -->
**Continue:** [Next page: ReACT for Children and Adolescents for Functional Seizures](06-react-for-children-and-adolescents.md)

**Related:** [Previous technique](04-sensory-grounding-and-attention-anchor.md) · [Technique collection and CBT resources](README.md) · [Seizure recovery overview](../06-functional-seizures.md) · [Episode safety plan](02-individualized-episode-safety-plan.md) · [Diagnostic reference](../../diagnostic-signs/06-functional-seizures.md)
