...
1. **Choose one example together.** If you recognize the pattern, discuss a low-stakes test with your clinician. First establish whether it provides needed information or safety.
2. **Choose a replacement action.** For example, read a message to understand it, keep it available, then reply without giving yourself an extra recall quiz.
3. **Keep useful support.** Notes, reminders, necessary rereading and agreed safety checks remain available. You do not have to rely on unaided memory.
4. **Review the effect.** Did the change make the activity easier or leave more attention for it? If it increased distress or practical mistakes, revise the plan rather than pushing harder.

The goal is not “never check again.” It is to stop a particular extra test from taking over. A clinician-guided [prediction-versus-performance exercise](05-prediction-and-performance.md) has an agreed purpose and stopping point; it should not become an all-day habit either. (*citations* [1](#citation-1), [2](#citation-2))
...
| <a id="citation-3"></a>3 | [FND-CIT-0188](../../../research/citation-index.md#fnd-cit-0188) — Neurosymptoms.org. *Functional Cognitive Symptoms*. [Source](https://neurosymptoms.org/en/symptoms/fnd-symptoms/functional-cognitive-symptoms/). Accessed September 21, 2026. | Specialist education on attention and memory-related worry; not a trial of reducing self-testing. | — |
| <a id="citation-4"></a>4 | [FND-CIT-0189](../../../research/citation-index.md#fnd-cit-0189) — Centre for Clinical Interventions, Government of Western Australia. *Helping Health Anxiety, Module 6: Reducing Checking and Reassurance Seeking*. [Source](https://www.cci.health.wa.gov.au/~/media/CCI/Consumer-Modules/Helping-Health-Anxiety/Helping-Health-Anxiety---06---Reducing-Checking-and-Reassurance-Seeking.pdf). Accessed September 21, 2026. | Adjacent health-anxiety guidance explaining the checking/reassurance cycle. Does not establish that the cycle occurs in every person with FCD or that reducing it treats FCD. | — |
