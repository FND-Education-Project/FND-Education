...
[Home](../../../README.md) › [Reference Library](../../README.md) › [Recovery Techniques](../README.md) › [Functional Sensory Symptoms](../07-functional-sensory-symptoms.md) › **Visual and Mirror Feedback for Altered Body Sensation**
<!-- NAV-BREADCRUMB:END -->
...
1. Identify a safe task for which an additional view has a plausible practical benefit.
2. Establish baseline performance with direct vision and appropriate limb support.
3. If needed, introduce a stable, glare-free mirror and explain exactly what it shows.
4. Use one brief task cue and monitor visual comfort and orientation.
5. Remove the feedback if it worsens function or symptoms.
6. Retain useful visual compensation; consider a small reduction only if real-world safety is preserved.
...
<!-- NAV-CONTEXT:START -->
**Continue:** [Next page: External Attention and Task Focus](07-external-attention-and-task-focus.md)

**Related:** [Previous technique](05-ordinary-contact-and-clothing.md) · [Detailed technique index](README.md) · [Symptom overview and reassessment guidance](../07-functional-sensory-symptoms.md) · [Diagnostic assessment](../../diagnostic-signs/07-functional-sensory-symptoms.md)
