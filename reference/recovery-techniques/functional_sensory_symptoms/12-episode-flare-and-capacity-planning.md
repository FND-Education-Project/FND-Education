...
[Home](../../../README.md) › [Reference Library](../../README.md) › [Recovery Techniques](../README.md) › [Functional Sensory Symptoms](../07-functional-sensory-symptoms.md) › **Episode, Flare and Available-Capacity Planning**
<!-- NAV-BREADCRUMB:END -->
...
1. Agree the established pattern and the changes that require urgent reassessment.
2. List the immediate hazards created by sensory loss or hypersensitivity.
3. Choose a short onset response and a no-warning fallback.
4. Select at most one rehearsed sensory or task strategy if the person finds it useful.
5. Plan a supported return, including who completes essential activities when capacity is limited.
6. Review after a changed pattern, injury or prolonged deterioration and revise the treatment demands as needed.
