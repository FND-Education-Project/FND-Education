...
[Home](../../../README.md) › [Reference Library](../../README.md) › [Recovery Techniques](../README.md) › [Functional Sensory Symptoms](../07-functional-sensory-symptoms.md) › **Coexisting Pain, Migraine and Medical Review**
<!-- NAV-BREADCRUMB:END -->
...
1. Establish the previous assessed pattern and the exact new or unresolved feature.
2. Triage urgent neurological, spinal, vascular or infectious possibilities before rehabilitation.
3. Perform a focused examination and select investigations or referral from the clinical findings.
4. Explain which findings support FND, which remain uncertain and which belong to a coexisting condition.
5. Coordinate condition-specific treatment with OT or physiotherapy and review medication burden when relevant.
6. Provide written follow-up and escalation instructions with a named care contact where possible.
...
<!-- NAV-CONTEXT:START -->
**Continue:** [Previous technique](09-tens-and-electrical-stimulation-review.md) · [Next technique](11-skin-pressure-and-injury-protection.md)
