...
[Home](../../../README.md) › [Reference Library](../../README.md) › [Recovery Techniques](../README.md) › [Functional Gait Disorder](../05-functional-gait-disorder.md) › **Treadmill and Body-Weight-Supported Walking**
<!-- NAV-BREADCRUMB:END -->

> **Working draft:** Clinical, equipment-safety and lived-experience review pending.
...
1. Record over-ground gait, aid use, assistance, distance and the feature targeted.
2. Inspect the device and fit the harness, checking groin, trunk and shoulder pressure and all attachment points.
3. Orient the person with the belt stationary; rehearse stopping and staff roles.
4. Establish stance, hand support and weight shift before belt movement.
5. Begin at the lowest clinically useful speed and unloading level with required foot and trunk guarding.
6. Use one cue for alternating steps, destination or rhythm; avoid multiple simultaneous corrections.
7. Limit the first bout and check symptoms, skin, blood pressure or cardiopulmonary response when indicated.
8. Adjust one variable at a time: speed, unloading, hand support, cueing or duration.
9. Practise over-ground walking with the usual aid during the same session to test carryover.
10. Stop for repeated toe catch, uncontrolled knee collapse, harness intolerance, presyncope, chest symptoms, altered awareness or loss of emergency control.
...
Specialist consensus includes treadmill and body-weight-supported approaches among possible gait strategies. Broader functional-motor trials do not establish that the device itself causes benefit or identify a functional-gait subgroup response. (*citations* [1](#citation-1), [2](#citation-2))
...
<!-- NAV-CONTEXT:START -->
**Continue:** [Next page: Mirror and Visual Feedback for Functional Gait Disorder](10-mirror-and-visual-feedback.md)

**Related:** [Previous technique: Stairs as a supervised bridge](08-stairs-as-a-supervised-bridge.md) · [Detailed technique index](README.md) · [Functional gait overview](../05-functional-gait-disorder.md) · [Functional limb-weakness treadmill page](../functional_limb_weakness/07-treadmill-and-body-weight-supported-walking.md)
