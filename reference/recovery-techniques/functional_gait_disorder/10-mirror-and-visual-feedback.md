...
[Home](../../../README.md) › [Reference Library](../../README.md) › [Recovery Techniques](../README.md) › [Functional Gait Disorder](../05-functional-gait-disorder.md) › **Mirror and Visual Feedback**
<!-- NAV-BREADCRUMB:END -->

> **Working draft:** Clinical, vestibular, sensory-access and lived-experience review pending.
...
Visual feedback is included in functional-motor consensus, and sign-based gait work supports observing task-dependent change. Controlled trials do not isolate mirror or video feedback as treatment for functional gait disorder. (*citations* [1](#citation-1), [2](#citation-2), [3](#citation-3))
...
<!-- NAV-CONTEXT:START -->
**Continue:** [Next page: Graded Community Walking and Environmental Complexity for Functional Gait Disorder](11-graded-community-walking-and-environmental-complexity.md)

**Related:** [Previous technique: Treadmill and body-weight-supported walking](09-treadmill-and-body-weight-supported-walking.md) · [Detailed technique index](README.md) · [Functional gait overview](../05-functional-gait-disorder.md) · [Persistent postural-perceptual dizziness](../13-persistent-postural-perceptual-dizziness.md)
