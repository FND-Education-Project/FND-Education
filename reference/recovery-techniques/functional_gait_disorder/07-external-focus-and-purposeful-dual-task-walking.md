...
[Home](../../../README.md) › [Reference Library](../../README.md) › [Recovery Techniques](../README.md) › [Functional Gait Disorder](../05-functional-gait-disorder.md) › **External Focus and Purposeful Dual-Task Walking**
<!-- NAV-BREADCRUMB:END -->

> **Working draft:** Clinical, cognitive-access and lived-experience review pending.
...
2. Establish a clear route, guarding plan and stopping cue.
3. Introduce one external target: destination, floor marker, object placement or task outcome.
4. Compare safety, continuity, assistance and effort.
5. If external focus helps and reserve is adequate, add one low-demand secondary task.
6. Keep the task predictable and easy to stop; avoid breakable, hot or heavy objects.
7. Progress either walking complexity or secondary-task complexity, never both in the same step.
8. Practise the task in a meaningful setting and then reduce unnecessary prompting.
9. Regress to external focus alone or single-task walking when dual-task cost becomes unsafe.
...
Functional-motor and occupational-therapy consensus support external focus, automatic movement and meaningful activity. Sign-based gait literature describes task-dependent change. Controlled trials have not isolated purposeful dual-task walking as a treatment component. (*citations* [1](#citation-1), [2](#citation-2), [3](#citation-3))
