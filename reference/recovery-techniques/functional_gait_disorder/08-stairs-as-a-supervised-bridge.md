...
[Home](../../../README.md) › [Reference Library](../../README.md) › [Recovery Techniques](../README.md) › [Functional Gait Disorder](../05-functional-gait-disorder.md) › **Stairs as a Supervised Bridge**
<!-- NAV-BREADCRUMB:END -->
...
Stair transformation is included in specialist functional-motor consensus, while sign-based gait review discusses improvement during more demanding tasks as a diagnostic clue. Neither source establishes stairs as a stand-alone treatment, and the risk is inherently higher than level practice. (*citations* [1](#citation-1), [2](#citation-2))
