...
**When this may fit:** When pain, eye symptoms, jaw problems, medicines or another condition may be contributing alongside FND. **[Clinical differential assessment and coordinated care]**
...
For example, **hemifacial spasm** is a different disorder involving involuntary movements on one side of the face. **Blepharospasm** involves involuntary eyelid closure and is not automatically functional. Following a facial-nerve injury, **synkinesis** means that movements become linked, such as an eye narrowing when the mouth moves. These distinctions require clinical assessment, not comparison with an online video. (*citation* [1](#citation-1)) (*citation* [2](#citation-2)) (*citation* [3](#citation-3))

Jaw or dental problems, migraine, eye disease and medicine effects can also change what care is needed. A drooping eyelid can have several causes, including disorders affecting nerve-to-muscle communication; do not treat it as FND on appearance alone. (*citation* [4](#citation-4))
...
1. what is already explained by the established functional pattern;
2. what needs another assessment;
3. which treatment addresses which problem;
4. who will coordinate follow-up.
...
New sudden facial droop, weakness or speech difficulty needs emergency assessment, even if it resolves. Facial weakness developing over hours or days also needs prompt review; conditions such as Bell’s palsy have time-sensitive care. Avoid self-diagnosis with forehead movements or a home “stroke test.” (*citation* [5](#citation-5)) (*citation* [2](#citation-2))
...
**New or different symptoms:** Sudden new facial droop or weakness, speech difficulty or other possible stroke symptoms need emergency assessment, even if they stop. Call your local emergency number; do not wait for an exercise to work. (*citation* [5](#citation-5))
...
| --- | --- | --- | --- |
| <a id="citation-1"></a>1 | [FND-CIT-0056](../../../research/citation-index.md#fnd-cit-0056) — Stone J. Functional facial symptoms. *Neurosymptoms.org*. [Source](https://neurosymptoms.org/en/symptoms/fnd-symptoms/functional-facial-symptoms/). Accessed September 22, 2026. | Specialist patient education on facial patterns and treatment; not trial evidence. | — |
| <a id="citation-2"></a>2 | [FND-CIT-0197](../../../research/citation-index.md#fnd-cit-0197) — NHS. Bell’s palsy. [Source](https://www.nhs.uk/conditions/bells-palsy/). Accessed September 22, 2026. | Adjacent facial-nerve and eye-protection guidance; does not diagnose FND or establish an FND exercise programme. | — |
| <a id="citation-3"></a>3 | [FND-CIT-0198](../../../research/citation-index.md#fnd-cit-0198) — University College London Hospitals NHS Foundation Trust. Complex Facial Clinic: botulinum toxin injections as part of the clinic treatment. [Source](https://www.uclh.nhs.uk/patients-and-visitors/patient-information-pages/complex-facial-clinic-botulinum-toxin-injections-part-clinic-treatment). Accessed September 22, 2026. | Adjacent facial-palsy/synkinesis treatment and adverse-effect information; not evidence of efficacy for functional facial symptoms. | — |
| <a id="citation-4"></a>4 | [FND-CIT-0021](../../../research/citation-index.md#fnd-cit-0021) — Frucht L, Perez DL, Callahan J, et al. Functional dystonia: differentiation from primary dystonia and multidisciplinary treatments. *Frontiers in Neurology*. 2021;11:605262. [DOI](https://doi.org/10.3389/fneur.2020.605262). | Clinical review of functional dystonia; individualized multidisciplinary guidance, not a facial rehabilitation trial. | — |
| <a id="citation-5"></a>5 | [FND-CIT-0108](../../../research/citation-index.md#fnd-cit-0108) — NHS. Symptoms of a stroke. [Source](https://www.nhs.uk/conditions/stroke/symptoms/). Accessed September 22, 2026. | Emergency safety guidance; not an FND treatment study. | — |
