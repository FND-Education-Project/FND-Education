...
2. Stabilize yourself and the limb comfortably, then reduce the relevant physical, sensory or cognitive load rather than holding the limb down by force.
3. Pick **one** previously useful cue—an external rhythm, competing movement, posture change, release cue or safe task—and use it briefly.
4. When it is safe, return to the interrupted activity at an easier level or with the planned adaptation instead of immediately testing whether the tremor is completely gone.
