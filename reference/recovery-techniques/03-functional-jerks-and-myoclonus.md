...
**Evidence labels:** **R** research-supported · **C** clinical consensus · **E** emerging. Symptom-specific controlled research is particularly limited here.
...
1. **Map the pattern — C.** For a limited period, note what happens just before a jerk: a body sensation, pain, muscle tightening, startle, posture, task, fatigue level or environment. The purpose is to find a useful intervention point, not to monitor every movement all day.
2. **Redirect attention at a familiar warning — C.** If there is enough warning and the situation is safe, shift to a chosen external task such as naming visible objects, keeping a simple rhythm, or continuing a well-practised functional movement. The best task is absorbing without being hazardous.
3. **Use a competing or continuous action — C.** A clinician may help identify a smooth, comfortable movement or purposeful task that is incompatible with the person’s usual pre-jerk pattern. Practise first when calm, then use it at an early warning.
4. **Address pain or muscle overactivity before the jerk — C.** If a consistent painful or tense area precedes the movement, treatment may include positioning, pacing, relaxation, musculoskeletal assessment or pain management. Do not forcefully stretch through a sudden movement.
5. **Practise function, not repeated jerk suppression — C.** Work on walking, reaching, sitting, conversation or another valued activity while using the selected cue. Constant suppression attempts can increase tension and self-monitoring.
6. **Graded activity and regulation — C.** Build a predictable amount of ordinary activity, rest and sleep routine. Where high arousal or startle is part of the pattern, a therapist may add paced breathing, relaxation or psychologically informed strategies.
