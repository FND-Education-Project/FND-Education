...
[Home](../../../README.md) › [Reference Library](../../README.md) › [Recovery Techniques](../README.md) › [Functional Limb Weakness](../01-functional-limb-weakness.md) › **Electrical Stimulation as an Adjunct**
<!-- NAV-BREADCRUMB:END -->

> **Working draft:** Specialist electrotherapy and lived-experience review pending.
...
1. Review diagnosis, coexisting neurological or musculoskeletal impairment and the exact functional target.
2. Complete the contraindication and precaution screen required by the device instructions, local electrotherapy policy and professional competencies. Include implanted electronic devices, pregnancy context, suspected thrombosis or malignancy at the site, impaired skin integrity or sensation, infection, epilepsy-related considerations and areas where current could affect the anterior neck or other vulnerable structures. These are not identical absolute rules for every device; resolve them before treatment.
3. Inspect and clean the skin, document sensation and choose electrodes appropriate to the target and device.
4. Increase stimulation gradually while communicating with the patient. Establish the lowest useful and tolerable sensory or motor response.
5. Pair stimulation with the person’s active attempt and an external task cue. Time it to the relevant movement phase.
6. Use a brief, predefined trial. Recheck skin, pain, fatigue, distress and movement quality.
7. Compare function with and without stimulation. Continue only when there is a useful net effect and a plan for active carryover.
8. If prescribed for home use, provide device-specific electrode mapping, settings limits, skin checks, cleaning, stop criteria and review date in writing.
