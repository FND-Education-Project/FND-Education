...
- **[Functional Cognitive Disorder](recovery-techniques/12-functional-cognitive-disorder.md)** — attention and metacognitive strategies, external supports and treatment of contributing conditions. [Thirteen detailed pages](recovery-techniques/functional_cognitive_disorder/README.md) cover each original entry, with memory-support safeguards and evidence limits.
