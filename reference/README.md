...
- **[Functional dystonia or fixed posturing](recovery-techniques/04-functional-dystonia.md)** — non-forceful positioning, task and sensory retraining, complication and equipment review, with a [thirteen-page detailed technique collection](recovery-techniques/functional_dystonia/README.md).
...
- **[Functional seizures](recovery-techniques/06-functional-seizures.md)** — safety, warning strategies, treatment choices and recovery support, with a [twelve-page detailed collection](recovery-techniques/functional_seizures/README.md).
- **[Functional sensory symptoms](recovery-techniques/07-functional-sensory-symptoms.md)** — sensory practice, meaningful activity, accommodations and safety, with a [twelve-page detailed collection](recovery-techniques/functional_sensory_symptoms/README.md).
- **[Functional visual symptoms](recovery-techniques/08-functional-visual-symptoms.md)** — explanation, visual feedback, graded tasks and care for migraine or other coexisting conditions.
- **[Functional speech and voice symptoms](recovery-techniques/09-functional-speech-and-voice-symptoms.md)** — automatic communication, rhythm, sound shaping and speech-language therapy strategies.
- **[Functional swallowing symptoms and globus](recovery-techniques/10-functional-swallowing-and-globus.md)** — assessed swallowing practice, relaxation and treatment of relevant coexisting conditions.
...
- **[Functional Cognitive Disorder](recovery-techniques/12-functional-cognitive-disorder.md)** — attention and metacognitive strategies, external supports and treatment of contributing conditions.
- **[Persistent postural-perceptual dizziness](recovery-techniques/13-persistent-postural-perceptual-dizziness.md)** — vestibular rehabilitation, habituation and graded exposure, with evidence limits stated.
- **[Functional facial symptoms](recovery-techniques/14-functional-facial-symptoms.md)** — individualized movement, positioning, communication and safety support; appearance-specific evidence remains limited.
