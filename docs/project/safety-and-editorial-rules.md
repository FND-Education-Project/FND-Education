...
- State emergency and medical-safety limitations wherever they matter.
- Distinguish an established personal symptom pattern from new, severe, injured, or substantially changed symptoms.
- Avoid both automatic emergency escalation and automatic dismissal as FND.
- Make clear that general education cannot determine what is safe for a particular person.
- Include relevant cautions, reasons to stop a self-management strategy, and reasons to seek professional assessment.

## Editorial safety

- Use non-stigmatizing language and explain older terminology when readers may encounter it.
