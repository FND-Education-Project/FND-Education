...
**Status: Accepted.** Keep the four current section names.
...
**Status: Accepted.** Overlapping subjects will use the recommended canonical homes and cross-links.
...
**Status: Accepted.** Rehabilitation, pacing, and daily accessibility will use the recommended division of responsibility.
...
**Status: To be decided after the main FND course is completed.**
...
1. Give every source one permanent ID in the central [Citation Index](../../research/citation-index.md).
2. Group all short quotations and supporting notes from the same article together.
3. State which claims the article supports.
4. Give the compact full citation once in that source group.
5. Link the source ID to its central citation record.
6. Repeat that compact source group on another page when the other page relies on it.
