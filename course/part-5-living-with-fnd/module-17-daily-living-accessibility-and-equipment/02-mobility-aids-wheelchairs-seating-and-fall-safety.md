...
This page covers canes, walkers, wheelchairs, braces, seating, positioning, transfer safety, fitting, training, funding, pressure and joint risks, independence, rehabilitation goals, and planned reassessment without blanket rules.
...
A person may have difficulty bathing, dressing, preparing food, cleaning, transferring, communicating, tolerating sensory environments, or leaving home. This may include fluctuating ability and the tension between needing help now and fearing that equipment will be judged as preventing recovery.
...
The page uses cautious wording because group research cannot tell one person exactly what caused a symptom, how it will change, or which approach will help. Researchers are still working to explain the lack of evidence for blanket rules about aids in FND. There is still uncertainty about long-term effects, highly individual tradeoffs, funding limitations, and the need to balance safety, independence, participation, conditioning, and rehabilitation.

### Questions you might ask a clinician

- “What task or barrier is this aid meant to solve?”
- “Is it safe and properly fitted?”
- “Does it improve independence or participation?”
- “What training is needed?”
- “When will its usefulness and risks be reviewed?”
...
- [Adapting Personal Care and Household Tasks](01-adapting-personal-care-and-household-tasks.md)
- **Mobility Aids, Wheelchairs, Seating, and Fall Safety — current page**
- [Sensory, Home, and Communication Access](03-sensory-home-and-communication-access.md)

## For Family, Friends, and Other Supporters

Ask before helping, and avoid automatic takeover.

Recognize when a task is unsafe for either person.
...
Important assessment points for this subject include collaborative trials, functional goals, training, maintenance, funding documentation, and planned reassessment.
...
[Research and Sources](#research-and-sources)
***
⬅️ **Previous article:** [Adapting Personal Care and Household Tasks](01-adapting-personal-care-and-household-tasks.md)

➡️ **Next article:** [Sensory, Home, and Communication Access](03-sensory-home-and-communication-access.md)
***
