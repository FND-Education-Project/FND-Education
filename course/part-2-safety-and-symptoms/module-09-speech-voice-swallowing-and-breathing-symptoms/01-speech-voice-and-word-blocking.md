...
**What should a reader understand in about one minute?** Write a stand-alone summary of this focused subject: Cover mutism, dysphonia, aphonia, stuttering, altered rhythm or accent, word blocking, automatic versus deliberate speech, communication access, speech-language therapy, and neurological or structural differentials. The reader should not have to read the module overview first to understand the page.
