...
**What should a reader understand in about one minute?** Write a short stand-alone summary for a tired or cognitively overloaded reader. The central purpose is: Prepare readers to respond to fluctuation without assuming either disaster or “just FND.” The reader should finish the summary understanding this outcome: The reader has a plan that supports calm adaptation while preserving medical vigilance. Do not attempt to teach every detail on the overview; explain the module’s purpose and the relationship among its focused pages.
