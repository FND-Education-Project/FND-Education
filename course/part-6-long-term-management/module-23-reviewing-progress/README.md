# Module 23 — Review Progress and Choose Next Steps
...
**What should a reader understand in about one minute?** Write a short stand-alone summary for a tired or cognitively overloaded reader. The central purpose is: Evaluate the course by knowledge, safety, participation, confidence, and support—not only symptom counts. The reader should finish the summary understanding this outcome: The person and supporter can recognize progress, unmet needs, and next steps without treating recovery as a pass-or-fail outcome. Do not attempt to teach every detail on the overview; explain the module’s purpose and the relationship among its focused pages.
...
**What can this subject feel or look like in ordinary life?** Describe progress that is uneven or easy to miss: safer episodes, faster recovery, better communication, improved access, more meaningful activity, greater confidence, or less supporter burden even when symptoms remain. Also make room for non-response and harm. Use several ordinary-life examples, acknowledge wide variation, and avoid turning the examples into a self-diagnostic checklist.
