...
**How should this page use “spoons”?** Link to the [full spoon-theory and available-capacity explanation](../../part-3-non-motor-symptoms/module-11-pain-migraine-fatigue-and-sleep/03-fatigue-and-post-activity-worsening.md#required-content-spoons-available-capacity-and-autonomic-claims). If a reader uses spoons, translate the metaphor into a practical question: what physical, cognitive, sensory, emotional and upright demands draw on **available capacity**, and what recovery follows? Do not translate spoon count into a claimed sympathetic–parasympathetic position. “Available capacity” is the preferred course term; the fatigue page records ten candidate alternatives for community and editorial testing.
