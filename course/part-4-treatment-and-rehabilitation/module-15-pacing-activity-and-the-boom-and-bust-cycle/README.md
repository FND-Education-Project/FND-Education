...
**What should a reader understand in about one minute?** Write a short stand-alone summary for a tired or cognitively overloaded reader. The central purpose is: Help readers plan activity amid variable symptoms while being honest about limited FND-specific pacing research. The reader should finish the summary understanding this outcome: The reader can test a flexible approach that respects current capacity while preserving meaningful activity and rehabilitation goals. Do not attempt to teach every detail on the overview; explain the module’s purpose and the relationship among its focused pages.
