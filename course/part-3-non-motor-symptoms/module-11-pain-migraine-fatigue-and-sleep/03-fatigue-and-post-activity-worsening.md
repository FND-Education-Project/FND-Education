...
### Required content: “spoons,” available capacity and autonomic claims

The completed page should explain that **spoon theory is a community metaphor, not a medical theory, biomarker or unit of energy**. Christine Miserandino introduced it in 2003 while describing life with lupus: a limited number of spoons stood for the usable capacity required by ordinary tasks. Communities living with chronic illness and disability have since used “spoons” for capacity that is limited, variable, invisible to others and affected by the accumulated cost of activity. It can be useful language without identifying why a person’s capacity is low. ([source record](../../../research/citation-index.md#fnd-cit-0062))

Compare three common explanations without treating them as interchangeable:

1. **Limited-resource metaphor:** each physical, cognitive, sensory, emotional or upright task may use some of the person’s currently available capacity.
2. **Load-and-recovery model:** usable capacity reflects the interaction between current demands and recovery, with possible contributions from fatigue, fatigability, pain, sleep, migraine, medication, deconditioning, orthostatic symptoms, FND symptoms and another illness.
3. **Autonomic-arousal explanation:** changing sympathetic and parasympathetic activity may contribute to symptoms or effort in some circumstances, but it is not what “spoons” means and is not an established gauge of an individual’s capacity. The branches do not occupy opposite ends of one slider; depending on the organ and situation they may change reciprocally, independently or together. FND studies report mixed group-level autonomic findings and do not show that low spoons equals one position on a sympathovagal graph. ([autonomic-control source record](../../../research/citation-index.md#fnd-cit-0063); [FND systematic-review source record](../../../research/citation-index.md#fnd-cit-0064))

It is reasonable to say that autonomic activity changes repeatedly across a day. Avoid saying that a person repeatedly “switches from sympathetic to parasympathetic,” that a balanced midpoint guarantees good capacity, or that a person can infer autonomic state from the number of spoons they feel they have. Low available capacity also does **not** by itself establish post-exertional malaise or ME/CFS.

For plain language, prefer **available capacity**. Ten candidate terms for community and editorial testing—not established clinical terms—are:

1. available capacity;
2. whole-system capacity;
3. remaining capacity;
4. capacity reserve;
5. load margin;
6. activity bandwidth;
7. demand tolerance;
8. recovery reserve;
9. symptom-buffer reserve; and
10. safe operating range.
...
**Which evidence and source notes will the completed page need?** Build a focused evidence record for “Fatigue and Post-Activity Worsening”: diagnostic sources, mechanism research, treatment studies, safety guidance, major disagreements, and any lived-experience material. The spoon-theory section already identifies the original community source ([FND-CIT-0062](../../../research/citation-index.md#fnd-cit-0062)), the autonomic-control model that allows reciprocal, independent and coactive patterns ([FND-CIT-0063](../../../research/citation-index.md#fnd-cit-0063)), and the heterogeneous FND autonomic literature ([FND-CIT-0064](../../../research/citation-index.md#fnd-cit-0064)). The completed evidence package should add fatigue-, pacing- and post-exertional-worsening sources rather than using autonomic findings as a substitute. For each important claim, note the best available source type, the population studied, major limitations, disagreements, and whether the source supports diagnosis, mechanism, treatment, safety or lived experience.
