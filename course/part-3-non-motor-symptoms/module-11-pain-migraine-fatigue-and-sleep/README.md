...
**What should a reader understand in about one minute?** Write a short stand-alone summary for a tired or cognitively overloaded reader. The central purpose is: Show how these disabling problems may accompany, trigger, maintain, or remain distinct from FND. The reader should finish the summary understanding this outcome: The reader understands why these problems deserve care in their own right and should not automatically be absorbed into the FND diagnosis. Do not attempt to teach every detail on the overview; explain the module’s purpose and the relationship among its focused pages.
