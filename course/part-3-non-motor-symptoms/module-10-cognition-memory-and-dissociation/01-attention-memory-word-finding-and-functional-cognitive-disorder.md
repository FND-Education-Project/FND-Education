...
**What should a reader understand in about one minute?** Write a stand-alone summary of this focused subject: Explain attention, processing speed, working memory, encoding and retrieval, episodic memory, semantic access, word finding, Functional Cognitive Disorder, formal assessment, other contributors, and external memory supports. The reader should not have to read the module overview first to understand the page.
