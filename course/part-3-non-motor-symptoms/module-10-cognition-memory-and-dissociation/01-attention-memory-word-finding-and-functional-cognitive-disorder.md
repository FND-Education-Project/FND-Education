...
This page explains attention, processing speed, working memory, encoding and retrieval, episodic memory, semantic access, word finding, Functional Cognitive Disorder, formal assessment, other contributors, and external memory supports.
...
This may include losing track of conversations, forgetting events, failing to find familiar words, slowed thinking, overload, zoning out, feeling detached, memory gaps, or difficulty doing several steps. These problems can be disabling even when formal test results are mixed.
...
The page uses cautious wording because group research cannot tell one person exactly what caused a symptom, how it will change, or which approach will help. Researchers are still working to explain uncertainty about the relationship among Functional Cognitive Disorder, cognitive symptoms within other FND forms, dissociation, attention, and formal memory performance. Research reports inconsistent test findings, heterogeneous definitions, and limited evidence for specific cognitive rehabilitation strategies.

### Questions you might ask a clinician

- “Is the difficulty with attention, learning, storage, or retrieval?”
- “Could sleep, migraine, medication, pain, seizures, or another condition contribute?”
- “Is neuropsychological assessment useful?”
- “Which external supports would reduce daily risk?”
...
- **Attention, Memory, Word Finding, and Functional Cognitive Disorder — current page**
- [Dissociation and Altered Awareness](02-dissociation-and-altered-awareness.md)

## For Family, Friends, and Other Supporters

Use agreed cues without testing, shaming, or removing autonomy.

Give one subject at a time and allow additional processing time.
...
Important assessment points for this subject include differential diagnosis involving neurodegeneration, epilepsy, migraine, sleep disorders, medication or substance effects, mood disorders, endocrine or nutritional disease, brain injury, and other neurological conditions. Neuropsychological assessment, performance validity, ecological validity, longitudinal change, and the risk of stigmatizing interpretation. Research limitations involving heterogeneous measures, small samples, psychiatric confounding, and overreliance on group averages.
...
➡️ **Next article:** [Dissociation and Altered Awareness](02-dissociation-and-altered-awareness.md)
***
