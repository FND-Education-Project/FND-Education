...
This page explains ordinary autonomic functions and symptoms such as sweating, temperature change, nausea, bowel change, dizziness, palpitations, and faintness, covers medication, illness, migraine, cardiac, endocrine, and recognized autonomic differentials without assuming “dysregulation.”
...
This may include sweating, chills, flushing, temperature difficulty, nausea, bowel changes, dizziness, racing or irregular heartbeat, and feeling faint. These sensations may occur with FND but can have many unrelated or overlapping causes.
...
The page uses cautious wording because group research cannot tell one person exactly what caused a symptom, how it will change, or which approach will help. Research has not established one autonomic abnormality across FND. Research also notes small and state-dependent studies, unclear direction of effects, overlap with recognized autonomic disorders, and the scientific limitations of broad dysregulation or polyvagal claims.

### Questions you might ask a clinician

- “What objective pattern has been documented?”
- “Could medication, dehydration, migraine, sleep, heart rhythm, hormones, or an autonomic disorder contribute?”
- “Which measurements are useful?”
- “When should monitoring stop or prompt assessment?”

### Something small you can do

A useful first step is to create a brief pattern record including context, duration, medication changes, and objective data only where useful.
...
- **Autonomic Symptoms, Overlap, and Other Causes — current page**
- [Useful Tracking, Measurements, and Clinical Assessment](02-useful-tracking-measurements-and-clinical-assessment.md)

## For Family, Friends, and Other Supporters

When invited, you may be able to help by documenting concerning patterns without dismissing them as anxiety or FND.
...
➡️ **Next article:** [Useful Tracking, Measurements, and Clinical Assessment](02-useful-tracking-measurements-and-clinical-assessment.md)
***
