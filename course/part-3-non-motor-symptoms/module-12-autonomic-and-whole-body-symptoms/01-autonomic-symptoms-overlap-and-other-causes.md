...
**What should the reader open next?** Use these module links: [Module overview](README.md); [Useful Tracking, Measurements, and Clinical Assessment](02-useful-tracking-measurements-and-clinical-assessment.md) Add cross-module links later only when they answer a clear next question.
...
<!-- NAV-CONTEXT:START -->
**In this module:** [Module overview](README.md) · [Next →](02-useful-tracking-measurements-and-clinical-assessment.md)
