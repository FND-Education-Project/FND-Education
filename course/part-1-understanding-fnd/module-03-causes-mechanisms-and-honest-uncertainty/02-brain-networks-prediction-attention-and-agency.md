...
**What should the reader open next?** Use these module links: [Module overview](README.md); [Causes, Risk Factors, Triggers, and Maintaining Factors](01-causes-risk-factors-triggers-and-maintaining-factors.md); [Physical, Psychological, and Social Factors—and How to Judge Claims](03-physical-psychological-and-social-factors-and-how-to-judge-claims.md) Add cross-module links later only when they answer a clear next question.
