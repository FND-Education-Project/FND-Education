...
**How can clinicians assess what may help this patient?** After a positive neurological diagnosis, invite rather than impose a collaborative formulation. Clarify which factors are evidence-based, reported by the person, clinically plausible, or still hypothetical. Ask about biological, psychological, and social contributors in proportion to relevance and consent, including accessibility and iatrogenic factors. Revisit the formulation when symptoms, circumstances, diagnoses, or treatment response change. Do not use trauma, psychiatric comorbidity, or acceptance of the formulation as diagnostic criteria.

**How can clinicians help the patient improve this symptom, difficulty, or aspect of care?** Explain how a formulation may help select symptom-specific rehabilitation, psychological treatment when relevant and acceptable, management of coexisting illness, education, social or occupational support, and accessibility changes. Distinguish evidence for a treatment from the theory used to explain why it might work. Define outcome broadly enough to include symptoms, function, participation, quality of life, safety, and burden of care. Avoid cure promises, universal staging, and the implication that persistent symptoms show poor effort.
...
Points supported: psychological stress is not required for diagnosis; diagnosis can be inclusionary rather than based only on exclusion.
...
**[FND-CIT-0005](../../../research/citation-index.md#fnd-cit-0005) — Pick et al. (2019)**

Points supported: FND aetiology remains uncertain; psychosocial adversities may be important risk factors for some people and should not disappear from an integrative account.

Short quotations from the abstract:

- “its aetiology remains enigmatic”
- “psychosocial adversities … as important risk factors for FND”

Citation: Pick S, Goldstein LH, Perez DL, Nicholson TR. Emotional processing in functional neurological disorder: a review, biopsychosocial model and research agenda. *Journal of Neurology, Neurosurgery & Psychiatry*. 2019;90(6):704–711. [https://doi.org/10.1136/jnnp-2018-319201](https://doi.org/10.1136/jnnp-2018-319201)

**[FND-CIT-0006](../../../research/citation-index.md#fnd-cit-0006) — Drane et al. (2021)**

Points supported: one proposed pathophysiology framework concerns interacting circuits and constructs including emotion processing, agency, attention, interoception, and predictive processing; substantial uncertainty remains.

Short quotations from the abstract:

- “dysfunction within and across different brain circuits”
- “emotion processing … agency, attention, interoception, and predictive processing/inference”
- “there is more work to be done”

Citation: Drane DL, Fani N, Hallett M, Khalsa SS, Perez DL, Roberts NA. A framework for understanding the pathophysiology of functional neurological disorder. *CNS Spectrums*. 2021;26(6):555–561. [https://doi.org/10.1017/S1092852920001789](https://doi.org/10.1017/S1092852920001789)

**[FND-CIT-0007](../../../research/citation-index.md#fnd-cit-0007) — Gelauff et al. (2014)**

Points supported: reported outcomes in functional motor-symptom studies vary; the evidence has important design and measurement limitations. Do not generalize this motor-symptom review to every FND subtype or use it to predict one person’s recovery.

Short quotation from the abstract:

- “Reported symptom outcome was highly variable”

Citation: Gelauff J, Stone J, Edwards M, Carson A. The prognosis of functional (psychogenic) motor symptoms: a systematic review. *Journal of Neurology, Neurosurgery & Psychiatry*. 2014;85(2):220–226. [https://doi.org/10.1136/jnnp-2013-305321](https://doi.org/10.1136/jnnp-2013-305321)

These quotations are research notes for the human author. The finished explanation should normally paraphrase the evidence in simple language, retain the citations, and distinguish risk factors, mechanisms, formulation, treatment rationale, and outcome evidence.

**When was the page last reviewed?** Keep the page marked as an authoring template until the human-authored explanation, evidence, terminology, safety wording, and links have been reviewed. Replace this note with the review date; use separate dates if terminology or safety guidance changes sooner.
