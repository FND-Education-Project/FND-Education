...
Points supported: positive diagnosis; symptoms are involuntary; neurological disease may coexist.
...
Points supported: FND includes varied, genuinely experienced symptom patterns; proposed mechanisms remain developing models.
...
**[FND-CIT-0004](../../../research/citation-index.md#fnd-cit-0004) — Bègue et al. (2019)**

Points supported: the software/hardware analogy can be useful but is incomplete; group-level structural findings need cautious interpretation.

Short quotations from the abstract:

- “this framework may require more nuanced considerations”
- “a ‘software’ and ‘hardware’ problem”

Citation: Bègue I, Adams C, Stone J, Perez DL. Structural alterations in functional neurological disorder and related conditions: a software and hardware problem? *NeuroImage: Clinical*. 2019;22:101798. [https://doi.org/10.1016/j.nicl.2019.101798](https://doi.org/10.1016/j.nicl.2019.101798)

These quotations are research notes for the human author. The finished explanation should normally paraphrase the evidence in simple language, retain the citations, and avoid presenting any analogy or proposed mechanism as settled fact.
