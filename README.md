...
13. **Building an Individual Treatment Team** — professional roles, coordination, care gaps, and working with limited local FND expertise.
14. **Rehabilitation and Neuroplastic Change** — practice, attention, automatic movement, graded rehabilitation, meaningful goals, setbacks, and realistic claims.
...
21. **Setbacks, Relapse, and Changing Symptoms** — fluctuation, response plans, rehabilitation adjustment, and reasons for medical reassessment.
...
**[Open the course structure and drafts](course/README.md)** to read all 97 course pages: 23 short module overviews and 74 focused pages.
...
The [functional-speech-and-voice collection](reference/recovery-techniques/functional_speech_and_voice_symptoms/README.md) expands its eleven original entries into eleven detailed pages, with practical communication support throughout.
...
- low-risk rehabilitation practices not well studied independently;
...
Module 1 is the human-authored starting model. Pages personally edited by the project lead carry a reviewer notice without an automatic-generation label. Other pages in Parts One through Six (Modules 1–23) now contain reader-facing working drafts, short source quotations, personal reflection questions, definition illustrations and citations. Automatically drafted pages retain a visible automatic-generation notice. None of these pages is treated as final or medically reviewed until the required human, evidence and safety review is complete.
